...
def parse_args():
    ...
    parser.add_argument('--raw_label_dir', help='the path of raw label', default=r'D:\project\jsai\VOC2007\Annotations')
    parser.add_argument('--pic_dir', help='the path of picture', default=r'D:\project\jsai\VOC2007\Images')
    parser.add_argument('--save_dir', help='the path of new label', default=r'D:\project\jsai\VOC2007\coco')
